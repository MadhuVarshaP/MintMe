...
export type { MintMeResume } from "./contracts/ResumeNFT.sol/MintMeResume";
export { MintMeResume__factory } from "./factories/contracts/ResumeNFT.sol/MintMeResume__factory";
