...
export default function HeroSection() {
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-body-text/5"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full border border-primary/20 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              href="/app"
              className="group flex items-center space-x-2 px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-xl font-semibold transition-all hover:scale-105 hover:shadow-lg"
            >
            ...
            <Link
              href="/about"
              className="flex items-center space-x-2 px-8 py-4 bg-white/90 backdrop-blur-sm hover:bg-white text-text-dark rounded-xl font-semibold transition-all hover:scale-105 border border-primary/20"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
            {[
              ...
              <div
                key={index}
                className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl border border-primary/10 hover:border-primary/20 transition-all hover:scale-105"
              >
